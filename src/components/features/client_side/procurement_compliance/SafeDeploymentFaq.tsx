...
const SafeDeploymentFaq: React.FC = () => {
  ...
  return (
    <section className="w-full py-16 px-4">
      <div className="max-w-[1240px] mx-auto text-center">
        ...
        >
         How Cerina ensures safe deployment:
   <br />
   DPIAs, clinical safety reviews, privacy-first approach 
...
export default SafeDeploymentFaq;