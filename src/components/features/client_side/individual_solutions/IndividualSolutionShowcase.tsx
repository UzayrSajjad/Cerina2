...
export default function IndividualSolutionShowcase({
  title = "Explore Cerina before you download",
  subtitle = "",
  body =
    "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.",
  ctaText = "Book a Demo",
  imageSrc = "/individual_solution_page/section_4/phone.svg",
}: Props) {
  return (
    <section className="py-12 sm:-mt-10 md:-mt-30 lg:-mt-40">
      <div className="max-w-[1200px] mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
          ...
          <div className="flex justify-center md:justify-end">
            <div className="relative w-full max-w-[250px] md:max-w-[350px]">
              <img
                src={imageSrc}
                alt="phone"
