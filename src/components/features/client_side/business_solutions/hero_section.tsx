            ...
            <div className="relative z-10 flex items-center min-h-full">
              <div className="ml-4 md:ml-8 lg:ml-20 xl:ml-28 flex items-center gap-8 w-full max-w-7xl mx-auto">
                ...
                >
                  ...
                  >
                   Tailored digital mental health solutions for organisations of all sizes
                  </h1>
                  ...
                  >
                   Trusted by NHS, private providers, and not-for-profit organisations
                  </p>
                ...
                <div className="pt-[140px] flex-1 hidden lg:flex justify-center items-center"
                >
                  <img
                    src="business_solution_page/hero_image.svg"
                    alt="Hero Image"
