...
export default function BusinessSolutionAudienceHero() {
  return (
    <section className="py-12 bg-[#FBF7F3]">
      <div className="max-w-[1100px] mx-auto px-4 text-center">
        ...
        >
          Whether you are an NHS service provider, or a not-for-profit organisation, discover how Cerina can work for you
        </h3>
        ...
        <div className="mt-8 flex justify-center">
          <a
            ...
            style={{ fontSize: 'clamp(0.8rem, 1vw, 1rem)', fontFamily: 'Montserrat, system-ui' }}
          >
            Book a Demo
          </a>
        </div>
